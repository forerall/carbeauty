...
class PayService
{
    ...
    public static function transToAccountAlipay($account, $money, $zfb_out_trade_no, $msg = '')
    {
        return self::getAlipayInstance()->transToAccount($account, $money, $zfb_out_trade_no, $msg);
    }
