...
class WxMsgCallback
{
    ...
    public function __construct($appId,$messageToken,$encodingAESKey)
    {
        $this->appId = $appId;
    ...
    public function start()
    {
        ...
        if ($this->encrypt_type=='aes') {
            $pc = new WXBizMsgCrypt($this->messageToken, $this->encodingAESKey, $this->appId);
    ...
    {
        return WxSafe::checkSignature([$this->timestamp, $this->nonce], $this->signature,$this->messageToken);
    }
