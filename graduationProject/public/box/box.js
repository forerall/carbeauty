...
//$('.form-body-content').find('a').ajaxContent({
//    event:'click',
//    loaderType:"img",
//    loadingMsg:"/box/images/loading.gif",
//    target:'.form-body-content',
//});
//$('#search_btn').click(function(){
//    var keyword = $('input[name="keyword"]').val();
//    load_url('/store/ajaxTravel?keyword='+encodeURI(keyword),'选择线路',800,500);
//});
//$('.select-btn').click(function(){
//    _form_hide();
//    select_callback($(this).closest('tr').data('item'));
//});