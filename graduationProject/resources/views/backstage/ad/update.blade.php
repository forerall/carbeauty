...
@section('content')
    <div class="page-content">
        <div class="page-header">
            <h1>
                {{$mode=='create'?'添加':''}}广告{{$mode=='edit'?'编辑':''}}{{$mode=='show'?'详情':''}}
                <small>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                @endif
                <form class="form-horizontal" id="" action="/backstage/ad{{$mode=='edit'?'/'.$item->id:''}}"
                      method="post">
                    {{csrf_field()}}
                    @if($mode=='edit')
                        {{method_field('PUT')}}
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="image">广告图</label>
                        ...
                        {{--<div class="space-2"></div>--}}
                        {{--<div class="form-group">--}}
                            {{--<label class="control-label col-xs-12 col-sm-1 no-padding-right" for="url">跳转地址</label>--}}
                            {{--<div class="col-xs-12 col-sm-11">--}}
                                {{--<input type="text" name="url" value="{{$item->url}}" class="col-xs-12 col-sm-6">--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        {{--<div class="space-2"></div>--}}
                        {{--<div class="form-group">--}}
                            {{--<label class="control-label col-xs-12 col-sm-1 no-padding-right" for="type">跳转类型</label>--}}
                            {{--<div class="col-xs-12 col-sm-11">--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-11">
                                <div class="input-group">
                                    <input class="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" type="text"
                                           name="begin" value="{{$item->begin}}">
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            //初始化配置...
            uploadImageBox($('#image'), '/upload?category=ad', '{{$item->image}}', 80);
