...
@section('content')
    <div class="page-content">
        <div class="page-header">
            <h1>
                {{$mode=='create'?'添加':''}}链接{{$mode=='edit'?'编辑':''}}{{$mode=='show'?'详情':''}}
                <small>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                @endif
                <form class="form-horizontal" id="" action="/backstage/links{{$mode=='edit'?'/'.$item->id:''}}"
                      method="post">
                    {{csrf_field()}}
                    @if($mode=='edit')
                        {{method_field('PUT')}}
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="url">标题</label>
