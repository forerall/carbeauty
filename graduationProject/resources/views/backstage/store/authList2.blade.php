...
@section('content')
    <div class="nav-search" id="nav-search">
        <form id="search_form" action="" method="get" enctype="multipart/form-data" class="form-search">
            <span class="input-icon">
                <input type="hidden" name="store_auth" value="{{request('store_auth')}}">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="order-nav">
                    <div{!! request('store_auth')=='1'?' class="current"':'' !!}><a href="?store_auth=1">待审核</a></div>
                    <div{!! request('store_auth')=='3'?' class="current"':'' !!}><a href="?store_auth=3">不通过</a></div>
                </div>
            </div>
                            ...
                            <tr data-item-id="{{$item->id}}">
                                ...
                                <td width="100">
                                    <div class="  action-buttons">
                                        <a class="blue showBtn" href="/backstage/authShow2/{{$item->id}}"><i
