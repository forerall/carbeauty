    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12 r-toolbar">
                <a href="/backstage/brand/create" class="btn btn-sm">新增</a>
            </div>
            <div class="col-xs-12">
                            ...
                            <tr data-item-id="{{$item->id}}">
                                ...
                                <td width="200">
                                    <div class="  action-buttons">
                                        <a class="green editBtn" href="/backstage/brand/{{$item->id}}/edit"><i
    ...
    <script>
        ...
        $(function () {
            $(".delBtn").click(function () {
                ...
                ajaxConfirm("{{url('/backstage/brand')}}/" + id, {}, "DELETE", function (data) {
                    location.reload();
                }, "确认删除");
            });
        })
