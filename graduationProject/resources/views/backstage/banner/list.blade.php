...
<a href="/backstage/banner/create" class="btn btn-sm">新增</a>
</div>
            <div class="col-xs-12">
...
<a class="blue showBtn" href="/backstage/banner/{{$item->id}}"><i class="icon-zoom-in bigger-130"></i></a>
<a class="green editBtn" href="/backstage/banner/{{$item->id}}/edit"><i class="icon-pencil bigger-130"></i></a>
...
@section('script')
    <script>
        ...
        $(function () {
            $(".delBtn").click(function(){var id = $(this).closest("tr").data("item-id");ajaxConfirm("{{url('/backstage/banner')}}/"+id,{},"DELETE",function(data){location.reload();},"确认删除");});
        })
    </script>
@stop